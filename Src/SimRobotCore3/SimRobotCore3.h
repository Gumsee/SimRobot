/**
 * @file SimRobotCore3.h
 * Declaration of an interface to the SimRobotCore3
 * @author Colin Graf
 */
...
namespace SimRobotCore3
{
  ...
  public:
     ...
     * @return The position
     */
    virtual const float* getPositionF() const = 0;
    ...
    /**
     * Moves the object to target position and rotation specified as vec3 Euler angles.
     * @param object The object to move.
     * @param position The target position.
