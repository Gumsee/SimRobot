 ...
 */
class Scene : public PhysicalObject, public GraphicalObject, public SimRobotCore3::Scene
{
public:
...
private:
  ...
  bool registerDrawingManager(SimRobotCore3::Controller3DDrawingManager& manager) override;
};
