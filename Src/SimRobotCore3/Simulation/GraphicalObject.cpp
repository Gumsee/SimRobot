...
bool GraphicalObject::registerDrawing(SimRobotCore3::Controller3DDrawing& drawing)
{
  controllerDrawings.push_back(&drawing);
  return true;
}

bool GraphicalObject::unregisterDrawing(SimRobotCore3::Controller3DDrawing& drawing)
{
